...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"AutogenerateItinerarySegue"]) {
        ...
        // delegate should be this view controller's parent view controller
        NSLog(@"composeItineraryViewController.delegate will be %@", self.delegate);
        composeItineraryViewController.delegate = self.delegate;
